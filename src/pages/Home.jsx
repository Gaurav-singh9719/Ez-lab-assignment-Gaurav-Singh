...
export default function Home() {
  return (
    <div className="min-h-screen bg-bgpeach bg-texture">
      {/* ✅ HERO SECTION */}
      <section className="relative flex flex-col md:flex-row justify-center items-center px-8 py-16 md:py-28 text-center md:text-left overflow-hidden">
        <img
          src="/images/hero/mandala-bg.png"
